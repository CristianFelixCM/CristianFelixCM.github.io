...
import { Protagonist } from "./Characters/Protagonist.js";
import { Enemy } from "./Characters/Enemy.js";
import { Mapa } from "./Map/Map.js";
import { Turnos } from "./Turnos.js";
import { Screens } from "./Screens.js";
export class Game {
    constructor(canvas2, contexto2D) {
        this.Enemys = [];
        this.pociones = [];
        this.flechas = [];
        this.paredes = [];
    ...
    initScene(gl) {
        return __awaiter(this, void 0, void 0, function* () {
            this.numeroPersonajeAndando = 0;
            this.interface = new Interface(this.canvas2, this.contexto2D);
            this.turnos = new Turnos();
            this.map = new Mapa();
    ...
    logic() {
        return __awaiter(this, void 0, void 0, function* () {
            switch (this.stateGamePlay) {
                case 0:
                    if (this.comprobarAccionPulsada() != -1) {
    ...
    actionsProtagonist() {
        switch (this.protagonist.getState()) {
            case 0:
                let actionSelect = this.comprobarAccionPulsada();
                if (actionSelect == 0) {
    ...
    comprobarAccionPulsada() {
        let teclacomprobada = this.tecla;
        this.tecla = -1;
